...
<template>
  <form @submit="handleSubmit" class="rounded-lg bg-vue-100 p-4 text-black shadow-md">
    ...
    <div class="space-y-4">
      <div>
        <label for="vue-iso-firstName" class="block text-sm font-medium text-vue-700"
          >First Name</label
        >
        <input
          type="text"
      ...
      <div>
        <label for="vue-iso-lastName" class="block text-sm font-medium text-vue-700"
          >Last Name</label
        >
        <input
          type="text"
      ...
      <div>
        <label for="vue-iso-password" class="block text-sm font-medium text-vue-700"
          >Password</label
        >
        <input
          type="password"
