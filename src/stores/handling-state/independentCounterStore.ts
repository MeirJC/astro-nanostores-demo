...
export function reactDecrement() {
  if ($reactCount.get() > 0) $reactCount.set($reactCount.get() - 1);
}
...
export function svelteDecrement() {
  if ($svelteCount.get() > 0) $svelteCount.set($svelteCount.get() - 1);
}
...
export function astroDecrement() {
  if ($astroCount.get() > 0) $astroCount.set($astroCount.get() - 1);
}
...
export function vueDecrement() {
  if ($vueCount.get() > 0) $vueCount.set($vueCount.get() - 1);
}
